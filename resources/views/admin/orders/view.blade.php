    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-4">My Order details</h4>
            </div>
            <div class="card-body">
                    <h4 class="text-primary">
                        <i class="fa fa-shoping-cart"></i>My Order Details
                        <a href="{{url('admin/orders')}}" class="btn btn-sm btn-danger btn-sm float-end">Back</a>
                        <a href="{{url('admin/invoice/'.$order->id.'/generate')}}" class="btn btn-sm btn-primary btn-sm float-end mx-1">
                            Download invoice
                        </a>
