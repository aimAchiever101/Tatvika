            ...
            <form action="{{url('admin/products')}}" method="POST" enctype="multipart/form-data">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="color-tab" data-bs-toggle="tab" data-bs-target="#color-tab-pane"
                     type="button" role="tab" aria-controls="color-tab-pane" aria-selected="false">Product Color</button>
                </li>
                </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="md-3">
                                    ...
                                    Color:<input type="checkbox" name="colors[]" value="{{$coloritem->id}}">
                                      {{$coloritem->name}}
                                <br/>
                                    Qunatity:<input type="number" name="colorquantity[]" style="width:70px;border:1px solid;">
                                    </div>
                                </div>
                                @empty
                                <div class="col-md-12">
